          ...
          {activeTab === "stickers" && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
               ...
               <div className="grid grid-cols-3 gap-3">
                 {[
                   { id: 'lny-stamp-1', icon: `${baseUrl}/assets/stickers/lny-stamp-1.png`, premium: false },
                   { id: 'lny-stamp-2', icon: `${baseUrl}/assets/stickers/lny-stamp-2.jpg`, premium: false },
                   { id: 'lny-stamp-3', icon: `${baseUrl}/assets/stickers/lny-stamp-3.jpeg`, premium: false },
                   { id: 'lny-horses', icon: `${baseUrl}/assets/stickers/lny-horses.png`, premium: false },
                   { id: 'heart-red', icon: `${baseUrl}/assets/stickers/heart-red.png`, premium: false },
                   { id: 'pepper', icon: `${baseUrl}/assets/stickers/pepper.png`, premium: false },
                   { id: 'tomato', icon: `${baseUrl}/assets/stickers/tomato.png`, premium: false },
                   { id: 'carrot', icon: `${baseUrl}/assets/stickers/carrot.png`, premium: false },
                   { id: 'potato', icon: `${baseUrl}/assets/stickers/potato.png`, premium: false },
                   { id: 'lemon', icon: `${baseUrl}/assets/stickers/lemon.png`, premium: false },
                   { id: 'pasta', icon: `${baseUrl}/assets/stickers/pasta.png`, premium: false },
                   { id: 'cheese', icon: `${baseUrl}/assets/stickers/cheese.png`, premium: false },
                   { id: 'pizza', icon: `${baseUrl}/assets/stickers/pizza.png`, premium: false },
                   { id: 'fish-plate', icon: `${baseUrl}/assets/stickers/fish-plate.png`, premium: false },
                   { id: 'fish-group', icon: `${baseUrl}/assets/stickers/fish-group.png`, premium: false },
                   { id: 'sardines', icon: `${baseUrl}/assets/stickers/sardines.png`, premium: false },
